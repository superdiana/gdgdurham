  ...
  <v-container class="pa-0 my-0">
    ...
    >
      ...
      >
        ...
        <span
          class="google-font mt-1 mb-0 grey--text"
          style="font-size:105%"
        >
          ...
          {{eventDetails.EventVenue | summery(50)}} <a
        ...
        <v-tooltip
          top
          slot="activator"
          v-if="eventDetails.EventWebsite.length>0"
        >
          <v-btn
            flat
            icon
        ...
        <v-tooltip
          top
          slot="activator"
          v-if="eventDetails.FBEventPageURL.length>0"
        >
          <v-btn
            flat
            icon
          ...
          <span>See {{eventDetails.FeatureEventName}} Twitter </span>
        </v-tooltip>
